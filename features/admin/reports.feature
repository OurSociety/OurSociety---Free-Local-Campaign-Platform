@admin
Feature: Admin can manage reports
  In order to be able to improve the quality of questions
  As an admin
  I need to be go through a list of reported questions

  Background:
    Given there are 5 "Report"s
#    * Example: Given there are 7 "Muffin"s
#    Given the following reports:
#      | Reported Question                                   | Reporting User |
#      | We should dramatically increase the inheritance tax | admin          |
