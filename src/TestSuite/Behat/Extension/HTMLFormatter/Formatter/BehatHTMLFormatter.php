...
namespace OurSociety\TestSuite\Behat\Extension\HTMLFormatter\Formatter;
 ...
 * BehatHTMLFormatter
 *
 * Replaces `emuse\BehatHTMLFormatter\Formatter\BehatHTMLFormatter` with one that works with latest Behat type-hints.
 */
...
class BehatHTMLFormatter implements Formatter
{
    ...
    public function onAfterStepTested(AfterStepTested $event)
    {
        ...
        if ($event->getStep()->hasArguments()) {
            /** @var \Behat\Gherkin\Node\NodeInterface $object */
