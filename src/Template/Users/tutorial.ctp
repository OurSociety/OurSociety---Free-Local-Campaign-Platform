    ...
    <div class="col-md-6 p-5 os-bg-split-light">
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tutorial-1">
                ...
                <article class="card card-default example example-watermark">
                ...
                <div class="nav pt-3 pull-right">
                    <a href="#tutorial-2" aria-controls="tutorial-2" role="tab" data-toggle="tab"
                       class="btn btn-primary" id="tutorial-1-continue">
                        <?= __('Continue') ?>
                    </a>
                </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="tutorial-2">
                ...
                <div class="nav pt-3 pull-right">
                    ...
                    <a href="#tutorial-3" aria-controls="tutorial-3" role="tab" data-toggle="tab"
                       class="btn btn-primary" id="tutorial-2-continue">
                        <?= __('Continue') ?>
                    </a>
                </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="tutorial-3">
                ...
                <div class="nav pt-3 pull-right">
                    ...
                    <a href="#tutorial-4" aria-controls="tutorial-4" role="tab" data-toggle="tab"
                       class="btn btn-primary" id="tutorial-3-continue">
                        <?= __('Continue') ?>
                    </a>
                </div>
            </div>
