...
<p>
    ...
    BOUND BY THE TERMS AND ALL TERMS INCORPORATED HEREIN BY REFERENCE. IT IS THE RESPONSIBILITY OF YOU, THE USER,
    CUSTOMER, OR PROSPECTIVE CUSTOMER TO READ THE TERMS AND CONDITIONS BEFORE PROCEEDING TO USE THIS SITE. IF YOU
    DO NOT EXPRESSLY AGREE TO ALL OF THE TERMS AND CONDITIONS, THEN PLEASE DO NOT ACCESS OR USE OUR SITES OR OUR
    SERVICES. THIS TERMS OF SERVICE AGREEMENT IS EFFECTIVE AS OF 08/10/2017.
</p>
...
<p>
    ...
    the relationship with our users and others which may interact or interface with OurSociety Inc., also known as
    OurSociety, located at 1583 Livingston Avenue, North Brunswick Township, New Jersey 08902 and our subsidiaries
    and affiliates, in association with the use of the OurSociety website, which includes <?= $this->Html->link('www.oursociety.org', '/') ?>, (the
...
<p>
    ...
    OurSociety is a online platform designed to remove the financial barriers associated with running for
    political office. OurSociety allows users to connect deeply with political candidates based on unique
    Societal Value Algorithms as well as detailed policies, plans, and visions.  OurSociety shifts the focus of
    voting from partisan party politics that use sensationalism to issue based decision making.
</p>
...
<p>
    ...
    downloadable programs, are the sole property of OurSociety Inc.. At its discretion, OurSociety Inc. may
    ...
    updated, modified or revised Services unless otherwise stipulated. OurSociety Inc. does hereby reserve the
    right to cancel and cease offering any of the aforementioned Services and/or products. You, as the end user
    and/or member, acknowledge, accept and agree that OurSociety Inc. shall not be held liable for any such
    updates, modifications, revisions, suspensions or discontinuance of any of our Services and/or products.
</p>
...
<p>
    ...
    frequent review of this Agreement and any and all applicable terms and policies should be made by you to
...
<p>
    ...
    be provided "AS IS" and as such OurSociety Inc. shall not assume any responsibility or obligation for the
...
<p>
    To register and become a "member" of the Site, you must be at least 18 years of age to enter into and form
    a legally binding contract. In addition, you must be in good standing and not an individual that has been
    previously barred from receiving OurSociety's Services under the laws and statutes of the United States or
    other applicable jurisdiction.
</p>

<p>
    When you register, OurSociety may collect information such as your name, e-mail address, birth date,
    gender, mailing address, occupation, industry and personal interests. You can edit your account information
    at any time. Once you register with OurSociety and sign in to our Services, you are no longer anonymous to us.
...
<p>
    ...
    OurSociety Inc. will have sufficient grounds and rights to suspend or terminate the member in violation of
    this aspect of the Agreement, and as such refuse any and all current or future use of OurSociety Inc.
    Services, or any portion thereof.
</p>

<p>
    It is OurSociety Inc.'s priority to ensure the safety and privacy of all its visitors, users and members,
    especially that of children. Therefore, it is for this reason that the parents of any child under the age of 13
    that permit their child or children access to the OurSociety website platform Services must create a "family"
    account, which will certify that the individual creating the "family" account is of 18 years of age and as
    such, the parent or legal guardian of any child or children registered under the "family" account. As the
    creator of the "family" account, s/he is thereby granting permission for his/her child or children to access
    the various Services provided, including, but not limited to, message boards, email, and/or instant
    messaging. It is the parent's and/or legal guardian's responsibility to determine whether any of the Services
    and/or content provided are age-appropriate for his/her child.
</p>
...
<p>
    ...
    responsibility to notify OurSociety Inc. immediately if you notice any unauthorized access or use of your
    account or password or any other breach of security. OurSociety Inc. shall not be held liable for any loss
...
<p>
    ...
    uploaded, emailed, transmitted or otherwise made available by way of the OurSociety Services, and as
    such, we do not guarantee the accuracy, integrity or quality of such content. It is expressly understood that
    by use of our Services, you may be exposed to content including, but not limited to, any errors or omissions
    in any content posted, and/or any loss or damage of any kind incurred as a result of the use of any content
    posted, emailed, transmitted or otherwise made available by OurSociety.
</p>

<p>
    Furthermore, you herein agree not to make use of OurSociety Inc.'s Services for the purpose of:
</p>
...
<ol type="a">
    ...
    <li>
        impersonating any individual or entity, including, but not limited to, any OurSociety officials, forum
    ...
    <li>
        uploading, posting, emailing, transmitting or otherwise offering any such content that may infringe
    ...
    <li>
        interfering with or disrupting any OurSociety Inc. Services, servers and/or networks that may be
    ...
    <li>
        ...
        OurSociety Inc. herein reserves the right to pre-screen, refuse and/or delete any content currently available
...
<p>
    OurSociety Inc. herein reserves the right to access, preserve and/or disclose member account information
...
<ol type="a">
    ...
    <li>
        protecting the rights, property or the personal safety of OurSociety Inc., its visitors, users and
        members, including the general public.
    </li>
</ol>

<p>
    OurSociety Inc. herein reserves the right to include the use of security components that may permit digital
    information or material to be protected, and that such use of information and/or material is subject to usage
    guidelines and regulations established by OurSociety Inc. or any other content providers supplying content
    services to OurSociety Inc.. You are hereby prohibited from making any attempt to override or circumvent any
...
<p>
    Upon registration, you hereby acknowledge that by using <?= $this->Html->link('www.oursociety.org', '/') ?> to send electronic
...
<p>
    ...
    comply with all applicable export and import laws, statutes and regulations, including, but not limited to, the
    <?= $this->Html->link('Export Administration Regulations', 'http://www.access.gpo.gov/bis/ear/ear_data.html') ?>,
    as well as the
    <?= $this->Html->link('sanctions control program of the United States', 'https://www.treasury.gov/resource-center/sanctions/Programs/Pages/Programs.aspx') ?>.
    Furthermore, you state and pledge that you:
</p>

<ol type="a">
    <li>
        are not on the list of prohibited individuals which may be identified on any government export
        nor a member of
...
<p>
    OurSociety Inc. shall not lay claim to ownership of any content submitted by any visitor, member, or user,
    nor make such content available for inclusion on our website Services. Therefore, you hereby grant and
    allow for OurSociety Inc. the below listed worldwide, royalty-free and non-exclusive licenses, as
    applicable:
</p>

<ol type="a">
    <li>
        The content submitted or made available for inclusion on the publicly accessible areas of
        OurSociety Inc.'s sites, the license provided to permit to use, distribute, reproduce, modify, adapt,
        ...
        available for viewing. This license shall be available so long as you are a member of OurSociety
        Inc.'s sites, and shall terminate at such time when you elect to discontinue your membership.
    </li>
    <li>
        Photos, audio, video and/or graphics submitted or made available for inclusion on the publicly
        accessible areas of OurSociety Inc.'s sites, the license provided to permit to use, distribute,
        ...
        member of OurSociety Inc.'s sites and shall terminate at such time when you elect to discontinue
        your membership.
    </li>
    <li>
        For any other content submitted or made available for inclusion on the publicly accessible areas
        of OurSociety Inc.'s sites, the continuous, binding and completely sub-licensable license which is
...
<p>
    Those areas which may be deemed "publicly accessible" areas of OurSociety Inc.'s sites are those such
    areas of our network properties which are meant to be available to the general public, and which would
    include message boards and groups that are openly available to both users and members. However, those
    areas which are not open to the public, and thus available to members only, would include our mail system
...
<p>
    OurSociety Inc. provides an area for our users and members to contribute feedback to our website. When
...
<ol type="a">
    ...
    <li>
        OurSociety shall not be liable or under any obligation to ensure or maintain confidentiality,
        expressed or implied, related to any Contributions;
    </li>
    <li>
        OurSociety shall be entitled to make use of and/or disclose any such Contributions in any such
        manner as they may see fit;
    </li>
    <li>
        the contributor's Contributions shall automatically become the sole property of OurSociety; and
    </li>
    <li>
        OurSociety is under no obligation to either compensate or provide any form of reimbursement in any manner or nature.
    </li>
</ol>
...
<p>
    All users and/or members herein agree to insure and hold OurSociety Inc., our subsidiaries, affiliates,
    agents, employees, officers, partners and/or licensors blameless or not liable for any claim or demand,
    which may include, but is not limited to, reasonable attorney fees made by any third party which may arise
    from any content a member or user of our site may submit, post, modify, transmit or otherwise make
    available through our Services, the use of OurSociety Services or your connection with these Services,
    your violations of the Terms of Service and/or your violation of any such rights of another person.
</p>
...
<p>
    ...
    commercial reason any part, use of, or access to OurSociety's sites.
</p>
...
<p>
    You herein acknowledge that OurSociety Inc. may set up any such practices and/or limits regarding the use
    of our Services, without limitation of the maximum number of days that any email, message posting or any
    other uploaded content shall be retained by OurSociety Inc., nor the maximum number of email messages
    that may be sent and/or received by any member, the maximum volume or size of any email message that
    may be sent from or may be received by an account on our Service, the maximum disk space allowable that
    shall be allocated on OurSociety Inc.'s servers on the member's behalf, and/or the maximum number of
    times and/or duration that any member may access our Services in a given period of time. In addition, you
    also agree that OurSociety Inc. has absolutely no responsibility or liability for the removal or failure to
    maintain storage of any messages and/or other communications or content maintained or transmitted by our Services.
    You also herein acknowledge that we reserve the right to delete or remove any account that is no longer active
    for an extended period of time. Furthermore, OurSociety Inc. shall reserve the right to modify, alter and/or
...
<p>
    ...
    OurSociety Inc.'s servers. In this manner, you will be able to access and search your message history from
    any computer with internet access. You also acknowledge that others have the option to use and save
    conversations with you in their own personal account on <?= $this->Html->link('www.oursociety.org', '/') ?>.
    It is your agreement to this TOS which establishes your consent to allow OurSociety Inc. to store any and all
...
<p>
    OurSociety Inc. shall reserve the right at any time it may deem fit, to modify, alter and or discontinue,
...
<ol type="a">
    ...
    <li>
        the nonpayment of any associated fees that may be owed by you in connection with your
        <?= $this->Html->link('www.oursociety.org', '/') ?> account Services.
    </li>
</ol>
...
<p>
    The termination of your account with <?= $this->Html->link('www.oursociety.org', '/') ?> shall include any
    and/or all of the following:
</p>

<ol type="a">
    <li>
        the removal of any access to all or part of the Services offered within <?= $this->Html->link('www.oursociety.org', '/') ?>;
    </li>
    <li>
        the deletion of your password and any and all related information, files, and any such content that may
        be associated with or inside your account, or any part thereof; and
    </li>
    <li>
...
<p>
    OurSociety does not offer any services or opportunities for advertisements to our user base.  Under no
    circumstance will you use OurSociety as a platform to advertise your product and/or service.  Doing so will
    result in immediate termination of your account and a ban from creating further accounts.
</p>
...
<p>
    Either OurSociety Inc. or any third parties may provide links to other websites and/or resources. Thus, you
    ...
    you acknowledge and agree that OurSociety Inc. shall not be responsible or liable, directly or indirectly,
    for any such damage or loss which may be a result of, caused or allegedly to be caused by or in connection
    with the use of or the reliance on any such content, goods or Services made available on or through any such
    site or resource.
</p>
...
<p>
    You do hereby acknowledge and agree that OurSociety Inc.'s Services and any essential software that may
    be used in connection with our Services ("Software") shall contain proprietary and confidential material that
    is protected by applicable intellectual property rights and other laws. Furthermore, you herein acknowledge and
    agree that any Content which may be contained in any advertisements or information presented by and through our
    Services or by advertisers is protected by copyrights, trademarks, patents or other proprietary rights and laws.
    Therefore, except for that which is expressly permitted by applicable law or as authorized by OurSociety Inc.
    or such applicable licensor, you agree not to alter, modify, lease, rent, loan, sell, distribute, transmit,
    broadcast, publicly perform and/or created any plagiaristic works which are based on OurSociety Inc. Services
    (e.g. Content or Software), in whole or part.
</p>

<p>
    OurSociety Inc. herein has granted you personal, non-transferable and non-exclusive rights and/or license to
    ...
    through any means other than through the interface which is provided by OurSociety Inc. for use in
...
<ol type="a">
    <li>
        THE USE OF OURSOCIETY INC. SERVICES AND SOFTWARE ARE AT THE SOLE RISK
        BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN "AS IS"
        AND/OR "AS AVAILABLE" BASIS. OURSOCIETY INC. AND OUR SUBSIDIARIES,
    ...
    <li>
        OURSOCIETY INC. AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS,
        PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT
        <ol type="i">
            <li>
                OURSOCIETY INC. SERVICES OR SOFTWARE WILL MEET YOUR REQUIREMENTS;
            </li>
            <li>
                OURSOCIETY INC. SERVICES OR SOFTWARE SHALL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE;
            </li>
            <li>
                THAT SUCH RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE OURSOCIETY INC. SERVICES OR SOFTWARE WILL
                BE ACCURATE OR RELIABLE;
            </li>
            <li>
                QUALITY OF ANY PRODUCTS, SERVICES, ANY INFORMATION OR
    ...
    <li>
        ...
        WAY OF OURSOCIETY INC. SERVICES OR SOFTWARE SHALL BE ACCESSED BY YOUR
    ...
    <li>
        ...
        MAY BE OBTAINED BY YOU FROM OURSOCIETY INC. OR BY WAY OF OR FROM OUR
...
<p>
    In the event you have a dispute, you agree to release OurSociety Inc. (and its officers, directors, employees,
...
<p>
    ...
    particular type of information, the phrase "Let the investor beware" is appropriate. OurSociety Inc.'s
    content is provided primarily for informational purposes, and no content that shall be provided or included
    in our Services is intended for trading or investing purposes. OurSociety Inc. and our licensors shall not be
...
<p>
    OurSociety Inc. may furnish you with notices, including those with regards to any changes to the TOS,
    ...
    received any and all notices that would have been delivered had you accessed our Services in an authorized manner.
</p>
...
<p>
    You herein acknowledge, understand and agree that all of the OurSociety Inc. trademarks, copyright, trade
    name, service marks, and other OurSociety Inc. logos and any brand features, and/or product and service
    names are trademarks and as such, are and shall remain the property of OurSociety Inc.. You herein agree
    not to display and/or use in any manner the OurSociety Inc. logo or marks without obtaining OurSociety
...
<p>
    OurSociety Inc. will always respect the intellectual property of others, and we ask that all of our users do
    the same. With regards to appropriate circumstances and at its sole discretion, OurSociety Inc. may disable
    and/or terminate the accounts of any user who violates our TOS and/or infringes the rights of others. If you
    feel that your work has been duplicated in such a way that would constitute copyright infringement, or if
    you believe your intellectual property rights have been otherwise violated, you should provide to us the
    following information:
</p>

<ol type="a">
    <li>
        The electronic or the physical signature of the individual that is authorized on behalf of the owner of
        the copyright or other intellectual property interest;
    </li>
    <li>
        A description of the copyrighted work or other intellectual property that you believe has been
        infringed upon;
    </li>
    <li>
...
<p>
    The OurSociety Inc. Agent for notice of claims of copyright or other intellectual property infringement can
...
<address>
    <strong>OurSociety Inc.</strong><br>
...
<p>
    BE IT KNOWN, that OurSociety Inc. complies with all applicable Federal Communications Commission
    rules and regulations regarding the closed captioning of video content. For more information, please visit
    our website at <?= $this->Html->link('www.oursociety.org', '/') ?>.
</p>
...
<p>
    This TOS constitutes the entire agreement between you and OurSociety Inc. and shall govern the use of our
    Services, superseding any prior version of this TOS between you and us with respect to OurSociety Inc.
    Services. You may also be subject to additional terms and conditions that may apply when you use or
    purchase certain other OurSociety Inc. Services, affiliate Services, third-party content or third-party
    software.
</p>
...
<p>
    It is at the mutual agreement of both you and OurSociety Inc. with regard to the TOS that the relationship
    between the parties shall be governed by the laws of the state of Delaware without regard to its conflict of
    law provisions and that any and all claims, causes of action and/or disputes, arising out of or relating to the
    TOS, or the relationship between you and OurSociety Inc., shall be filed within the courts having
    jurisdiction within the County of Middlesex, New Jersey or the U.S. District Court located in said state.
    You and OurSociety Inc. agree to submit to the jurisdiction of the courts as previously mentioned, and
    agree to waive any and all objections to the exercise of jurisdiction over the parties by such courts and to
...
<p>
    At any time, should OurSociety Inc. fail to exercise or enforce any right or provision of the TOS, such
...
<p>
    ...
    action arising out of or related to the use of our Services or the TOS must be filed within 4 year(s) after said
...
<p>
    Please report any and all violations of this TOS to OurSociety Inc. as follows:
</p>
